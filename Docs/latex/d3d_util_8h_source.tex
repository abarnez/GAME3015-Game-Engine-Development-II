...
\label{d3d_util_8h_source}\index{GAME3015-\/Game-\/Engine-\/Development-\/II/Assignment1/Assignment1/Common/d3dUtil.h@{GAME3015-\/Game-\/Engine-\/Development-\/II/Assignment1/Assignment1/Common/d3dUtil.h}}
...
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00158}00158     \textcolor{comment}{// Give it a name so we can look it up by name.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00159}\mbox{\hyperlink{struct_mesh_geometry_a9cfdc0d2b907a9059b32fccae59d9813}{00159}}     std::string \mbox{\hyperlink{struct_mesh_geometry_a9cfdc0d2b907a9059b32fccae59d9813}{Name}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00160}00160 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00161}00161     \textcolor{comment}{// System memory copies.  Use Blobs because the vertex/index format can be generic.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00162}00162     \textcolor{comment}{// It is up to the client to cast appropriately.  }}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00163}\mbox{\hyperlink{struct_mesh_geometry_a79e5e540605f4205197154469bf4194e}{00163}}     Microsoft::WRL::ComPtr<ID3DBlob> \mbox{\hyperlink{struct_mesh_geometry_a79e5e540605f4205197154469bf4194e}{VertexBufferCPU}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00164}\mbox{\hyperlink{struct_mesh_geometry_aa9a4e934b370f9c716217b01c15bad32}{00164}}     Microsoft::WRL::ComPtr<ID3DBlob> \mbox{\hyperlink{struct_mesh_geometry_aa9a4e934b370f9c716217b01c15bad32}{IndexBufferCPU}}  = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00165}00165 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00166}\mbox{\hyperlink{struct_mesh_geometry_afc3be274ba79e6984225407560350438}{00166}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_mesh_geometry_afc3be274ba79e6984225407560350438}{VertexBufferGPU}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00167}\mbox{\hyperlink{struct_mesh_geometry_a98d981b7fd0627dbe53c31ce83d23d8f}{00167}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_mesh_geometry_a98d981b7fd0627dbe53c31ce83d23d8f}{IndexBufferGPU}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00168}00168 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00169}\mbox{\hyperlink{struct_mesh_geometry_a99726cbb8b6acc9599ccaae768032104}{00169}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_mesh_geometry_a99726cbb8b6acc9599ccaae768032104}{VertexBufferUploader}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00170}\mbox{\hyperlink{struct_mesh_geometry_a49a2735dd265091e5451c26c7e4fceb9}{00170}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_mesh_geometry_a49a2735dd265091e5451c26c7e4fceb9}{IndexBufferUploader}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00171}00171 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00172}00172     \textcolor{comment}{// Data about the buffers.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00173}\mbox{\hyperlink{struct_mesh_geometry_a809bd47a42dcf1f8512c55c663354fe9}{00173}}     UINT \mbox{\hyperlink{struct_mesh_geometry_a809bd47a42dcf1f8512c55c663354fe9}{VertexByteStride}} = 0;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00174}\mbox{\hyperlink{struct_mesh_geometry_a95d475544535050a64a841489a0e3269}{00174}}     UINT \mbox{\hyperlink{struct_mesh_geometry_a95d475544535050a64a841489a0e3269}{VertexBufferByteSize}} = 0;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00175}\mbox{\hyperlink{struct_mesh_geometry_a4ab6fed21b08b6008850e43f8e912506}{00175}}     DXGI\_FORMAT \mbox{\hyperlink{struct_mesh_geometry_a4ab6fed21b08b6008850e43f8e912506}{IndexFormat}} = DXGI\_FORMAT\_R16\_UINT;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00176}\mbox{\hyperlink{struct_mesh_geometry_ada154aecae7686cb96099c259fa49946}{00176}}     UINT \mbox{\hyperlink{struct_mesh_geometry_ada154aecae7686cb96099c259fa49946}{IndexBufferByteSize}} = 0;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00177}00177 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00178}00178     \textcolor{comment}{// A MeshGeometry may store multiple geometries in one vertex/index buffer.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00179}00179     \textcolor{comment}{// Use this container to define the Submesh geometries so we can draw}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00180}00180     \textcolor{comment}{// the Submeshes individually.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00181}\mbox{\hyperlink{struct_mesh_geometry_a0b2c5e9269169fb7c5d838240957fd10}{00181}}     std::unordered\_map<std::string, SubmeshGeometry> \mbox{\hyperlink{struct_mesh_geometry_a0b2c5e9269169fb7c5d838240957fd10}{DrawArgs}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00182}00182 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00183}\mbox{\hyperlink{struct_mesh_geometry_acec2bf9adf97ea1263702d66a69c8513}{00183}}     D3D12\_VERTEX\_BUFFER\_VIEW \mbox{\hyperlink{struct_mesh_geometry_acec2bf9adf97ea1263702d66a69c8513}{VertexBufferView}}()\textcolor{keyword}{const}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00184}00184 \textcolor{keyword}{    }\{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00185}00185         D3D12\_VERTEX\_BUFFER\_VIEW vbv;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00186}00186         vbv.BufferLocation = \mbox{\hyperlink{struct_mesh_geometry_afc3be274ba79e6984225407560350438}{VertexBufferGPU}}-\/>GetGPUVirtualAddress();}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00187}00187         vbv.StrideInBytes = \mbox{\hyperlink{struct_mesh_geometry_a809bd47a42dcf1f8512c55c663354fe9}{VertexByteStride}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00188}00188         vbv.SizeInBytes = \mbox{\hyperlink{struct_mesh_geometry_a95d475544535050a64a841489a0e3269}{VertexBufferByteSize}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00189}00189 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00190}00190         \textcolor{keywordflow}{return} vbv;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00191}00191     \}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00192}00192 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00193}\mbox{\hyperlink{struct_mesh_geometry_a93ffd50cd07c380b0cade539ba82e8a5}{00193}}     D3D12\_INDEX\_BUFFER\_VIEW \mbox{\hyperlink{struct_mesh_geometry_a93ffd50cd07c380b0cade539ba82e8a5}{IndexBufferView}}()\textcolor{keyword}{const}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00194}00194 \textcolor{keyword}{    }\{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00195}00195         D3D12\_INDEX\_BUFFER\_VIEW ibv;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00196}00196         ibv.BufferLocation = \mbox{\hyperlink{struct_mesh_geometry_a98d981b7fd0627dbe53c31ce83d23d8f}{IndexBufferGPU}}-\/>GetGPUVirtualAddress();}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00197}00197         ibv.Format = \mbox{\hyperlink{struct_mesh_geometry_a4ab6fed21b08b6008850e43f8e912506}{IndexFormat}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00198}00198         ibv.SizeInBytes = \mbox{\hyperlink{struct_mesh_geometry_ada154aecae7686cb96099c259fa49946}{IndexBufferByteSize}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00199}00199 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00200}00200         \textcolor{keywordflow}{return} ibv;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00201}00201     \}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00202}00202 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00203}00203     \textcolor{comment}{// We can free this memory after we finish upload to the GPU.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00204}\mbox{\hyperlink{struct_mesh_geometry_aba9e36f1f4439a88bed25a48cc337ece}{00204}}     \textcolor{keywordtype}{void} \mbox{\hyperlink{struct_mesh_geometry_aba9e36f1f4439a88bed25a48cc337ece}{DisposeUploaders}}()}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00205}00205     \{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00206}00206         \mbox{\hyperlink{struct_mesh_geometry_a99726cbb8b6acc9599ccaae768032104}{VertexBufferUploader}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00207}00207         \mbox{\hyperlink{struct_mesh_geometry_a49a2735dd265091e5451c26c7e4fceb9}{IndexBufferUploader}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00208}00208     \}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00209}00209 \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00210}00210 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00211}\mbox{\hyperlink{struct_light}{00211}} \textcolor{keyword}{struct }\mbox{\hyperlink{struct_light}{Light}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00212}00212 \{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00213}\mbox{\hyperlink{struct_light_a015096e9847bd33050b73a13c200a4c1}{00213}}     DirectX::XMFLOAT3 \mbox{\hyperlink{struct_light_a015096e9847bd33050b73a13c200a4c1}{Strength}} = \{ 0.5f, 0.5f, 0.5f \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00214}\mbox{\hyperlink{struct_light_a21cc24ec9f914edbbc090bb3460fc645}{00214}}     \textcolor{keywordtype}{float} \mbox{\hyperlink{struct_light_a21cc24ec9f914edbbc090bb3460fc645}{FalloffStart}} = 1.0f;                          \textcolor{comment}{// point/spot light only}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00215}\mbox{\hyperlink{struct_light_afd9b6884af30b8fdc7fee9a982572a0f}{00215}}     DirectX::XMFLOAT3 \mbox{\hyperlink{struct_light_afd9b6884af30b8fdc7fee9a982572a0f}{Direction}} = \{ 0.0f, -\/1.0f, 0.0f \};\textcolor{comment}{// directional/spot light only}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00216}\mbox{\hyperlink{struct_light_a38fa90b8cea6b266b13c3dc865828a14}{00216}}     \textcolor{keywordtype}{float} \mbox{\hyperlink{struct_light_a38fa90b8cea6b266b13c3dc865828a14}{FalloffEnd}} = 10.0f;                           \textcolor{comment}{// point/spot light only}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00217}\mbox{\hyperlink{struct_light_a759c2228a71bfc669460ae4210a48e52}{00217}}     DirectX::XMFLOAT3 \mbox{\hyperlink{struct_light_a759c2228a71bfc669460ae4210a48e52}{Position}} = \{ 0.0f, 0.0f, 0.0f \};  \textcolor{comment}{// point/spot light only}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00218}\mbox{\hyperlink{struct_light_a7202d90f1b073d3ac170c18451f0bc92}{00218}}     \textcolor{keywordtype}{float} \mbox{\hyperlink{struct_light_a7202d90f1b073d3ac170c18451f0bc92}{SpotPower}} = 64.0f;                            \textcolor{comment}{// spot light only}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00219}00219 \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00220}00220 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00221}\mbox{\hyperlink{d3d_util_8h_a3654e541e465ac5978e40d2fc5e7fdfa}{00221}} \textcolor{preprocessor}{\#define MaxLights 16}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00222}00222 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00223}\mbox{\hyperlink{struct_material_constants}{00223}} \textcolor{keyword}{struct }\mbox{\hyperlink{struct_material_constants}{MaterialConstants}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00224}00224 \{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00225}\mbox{\hyperlink{struct_material_constants_a83cf6d979493301808d0e4b350c3e0a4}{00225}}     DirectX::XMFLOAT4 \mbox{\hyperlink{struct_material_constants_a83cf6d979493301808d0e4b350c3e0a4}{DiffuseAlbedo}} = \{ 1.0f, 1.0f, 1.0f, 1.0f \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00226}\mbox{\hyperlink{struct_material_constants_a7b2282a2a351b4327324fc7456a1cd85}{00226}}     DirectX::XMFLOAT3 \mbox{\hyperlink{struct_material_constants_a7b2282a2a351b4327324fc7456a1cd85}{FresnelR0}} = \{ 0.01f, 0.01f, 0.01f \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00227}\mbox{\hyperlink{struct_material_constants_ab931870a28dc4f2afdf7d6f565d06659}{00227}}     \textcolor{keywordtype}{float} \mbox{\hyperlink{struct_material_constants_ab931870a28dc4f2afdf7d6f565d06659}{Roughness}} = 0.25f;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00228}00228 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00229}00229     \textcolor{comment}{// Used in texture mapping.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00230}\mbox{\hyperlink{struct_material_constants_a5d631fb90e1b2557008841d059c322c8}{00230}}     DirectX::XMFLOAT4X4 \mbox{\hyperlink{struct_material_constants_a5d631fb90e1b2557008841d059c322c8}{MatTransform}} = \mbox{\hyperlink{class_math_helper_a68b4e9af95b1a36aad30ea80839f6b19}{MathHelper::Identity4x4}}();}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00231}00231 \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00232}00232 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00233}00233 \textcolor{comment}{// Simple struct to represent a material for our demos.  A production 3D engine}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00234}00234 \textcolor{comment}{// would likely create a class hierarchy of Materials.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00235}\mbox{\hyperlink{struct_material}{00235}} \textcolor{keyword}{struct }\mbox{\hyperlink{struct_material}{Material}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00236}00236 \{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00237}00237     \textcolor{comment}{// Unique material name for lookup.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00238}\mbox{\hyperlink{struct_material_a793dc9034c137caf3d8b3b4b0f9d451b}{00238}}     std::string \mbox{\hyperlink{struct_material_a793dc9034c137caf3d8b3b4b0f9d451b}{Name}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00239}00239 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00240}00240     \textcolor{comment}{// Index into constant buffer corresponding to this material.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00241}\mbox{\hyperlink{struct_material_a7bafa2db0678ffe18c5e51f3d0e45df9}{00241}}     \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_material_a7bafa2db0678ffe18c5e51f3d0e45df9}{MatCBIndex}} = -\/1;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00242}00242 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00243}00243     \textcolor{comment}{// Index into SRV heap for diffuse texture.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00244}\mbox{\hyperlink{struct_material_ae0af64dd847942c26368b71faefe747e}{00244}}     \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_material_ae0af64dd847942c26368b71faefe747e}{DiffuseSrvHeapIndex}} = -\/1;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00245}00245 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00246}00246     \textcolor{comment}{// Index into SRV heap for normal texture.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00247}\mbox{\hyperlink{struct_material_af6139531ff098c78d4d03d2fa232f27e}{00247}}     \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_material_af6139531ff098c78d4d03d2fa232f27e}{NormalSrvHeapIndex}} = -\/1;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00248}00248 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00249}00249     \textcolor{comment}{// Dirty flag indicating the material has changed and we need to update the constant buffer.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00250}00250     \textcolor{comment}{// Because we have a material constant buffer for each FrameResource, we have to apply the}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00251}00251     \textcolor{comment}{// update to each FrameResource.  Thus, when we modify a material we should set }}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00252}00252     \textcolor{comment}{// NumFramesDirty = gNumFrameResources so that each frame resource gets the update.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00253}\mbox{\hyperlink{struct_material_aacbebebfe577cd18d8652a01e8fae8c0}{00253}}     \textcolor{keywordtype}{int} \mbox{\hyperlink{struct_material_aacbebebfe577cd18d8652a01e8fae8c0}{NumFramesDirty}} = \mbox{\hyperlink{d3d_util_8h_a7c82b7821d2662eb6e0cfdc08a6c4bd4}{gNumFrameResources}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00254}00254 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00255}00255     \textcolor{comment}{// Material constant buffer data used for shading.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00256}\mbox{\hyperlink{struct_material_a35fea10a83b154ec1e16d083e2d4e41f}{00256}}     DirectX::XMFLOAT4 \mbox{\hyperlink{struct_material_a35fea10a83b154ec1e16d083e2d4e41f}{DiffuseAlbedo}} = \{ 1.0f, 1.0f, 1.0f, 1.0f \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00257}\mbox{\hyperlink{struct_material_afa0eeacfe7ed75af247eb08edb14d7b8}{00257}}     DirectX::XMFLOAT3 \mbox{\hyperlink{struct_material_afa0eeacfe7ed75af247eb08edb14d7b8}{FresnelR0}} = \{ 0.01f, 0.01f, 0.01f \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00258}\mbox{\hyperlink{struct_material_a909d7c43062f35668676364d3873449d}{00258}}     \textcolor{keywordtype}{float} \mbox{\hyperlink{struct_material_a909d7c43062f35668676364d3873449d}{Roughness}} = .25f;}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00259}\mbox{\hyperlink{struct_material_a3fd206fc6ecb51634475f22ff17528d0}{00259}}     DirectX::XMFLOAT4X4 \mbox{\hyperlink{struct_material_a3fd206fc6ecb51634475f22ff17528d0}{MatTransform}} = \mbox{\hyperlink{class_math_helper_a68b4e9af95b1a36aad30ea80839f6b19}{MathHelper::Identity4x4}}();}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00260}00260 \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00261}00261 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00262}\mbox{\hyperlink{struct_texture}{00262}} \textcolor{keyword}{struct }\mbox{\hyperlink{struct_texture}{Texture}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00263}00263 \{}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00264}00264     \textcolor{comment}{// Unique material name for lookup.}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00265}\mbox{\hyperlink{struct_texture_aff942a6e6a80c06965b239a73ad04a2d}{00265}}     std::string \mbox{\hyperlink{struct_texture_aff942a6e6a80c06965b239a73ad04a2d}{Name}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00266}\mbox{\hyperlink{struct_texture_a4c7d999ed2653374b600a75eb8a307f7}{00266}}     std::wstring \mbox{\hyperlink{struct_texture_a4c7d999ed2653374b600a75eb8a307f7}{Filename}};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00267}00267 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00268}\mbox{\hyperlink{struct_texture_ae273d56b160aa483303d13b903e00122}{00268}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_texture_ae273d56b160aa483303d13b903e00122}{Resource}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00269}\mbox{\hyperlink{struct_texture_a9e4e92ab08debca51ed2635cd3f9c5a7}{00269}}     Microsoft::WRL::ComPtr<ID3D12Resource> \mbox{\hyperlink{struct_texture_a9e4e92ab08debca51ed2635cd3f9c5a7}{UploadHeap}} = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00270}00270 \};}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00271}00271 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00272}00272 \textcolor{preprocessor}{\#ifndef ThrowIfFailed}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00273}\mbox{\hyperlink{d3d_util_8h_af3892d76181a8a44edbd1a71a6ae9b97}{00273}} \textcolor{preprocessor}{\#define ThrowIfFailed(x)                                              \(\backslash\)}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00274}00274 \textcolor{preprocessor}{\{                                                                     \(\backslash\)}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00275}00275 \textcolor{preprocessor}{    HRESULT hr\_\_ = (x);                                               \(\backslash\)}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00276}00276 \textcolor{preprocessor}{    std::wstring wfn = AnsiToWString(\_\_FILE\_\_);                       \(\backslash\)}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00277}00277 \textcolor{preprocessor}{    if(FAILED(hr\_\_)) \{ throw DxException(hr\_\_, L\#x, wfn, \_\_LINE\_\_); \} \(\backslash\)}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00278}00278 \textcolor{preprocessor}{\}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00279}00279 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00280}00280 }
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00281}00281 \textcolor{preprocessor}{\#ifndef ReleaseCom}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00282}\mbox{\hyperlink{d3d_util_8h_a0670b8f550c413fb123fa6df8dc87267}{00282}} \textcolor{preprocessor}{\#define ReleaseCom(x) \{ if(x)\{ x-\/>Release(); x = 0; \} \}}}
\DoxyCodeLine{\Hypertarget{d3d_util_8h_source_l00283}00283 \textcolor{preprocessor}{\#endif}}
